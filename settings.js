...
SESSION_NAME: process.env.SESSION_NAME === undefined ? "dodo" : process.env.SESSION_NAME,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*SALAM , ANA 5DAM DB!!*" : process.env.ALIVE_MSG,
...
SEEDER_GMAIL: process.env.SEEDER_GMAIL === undefined ? "nadiradam44@gmail.com" : process.env.SEEDER_GMAIL,
SEEDER_PASSWORD: process.env.SEEDER_PASSWORD === undefined ? "adam124" : process.env.SEEDER_PASSWORD,
